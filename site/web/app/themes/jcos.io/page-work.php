...
function beans_child_home_add_title() {
    ?>
        <div class="uk-container uk-container-center uk-panel-box">
            <h1>Portfolio</h1>
            <h4>These are the projects that I have worked on. The credit is not all mine as I have collaborated with other designers, developers and various roles.</h4>
            <h4>Some of my work in listed flashy filterable grid...</h4>
            <h4>Interested to work with me? <a href="https://jcos.io/contact/">Contact me</a>.</h4>
        </div>
    <?php
}
